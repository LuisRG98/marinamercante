    ...
    <hr>
  	<div class="container col-md-12">
	    ...
	    <input hidden="hidden" type="text" name="properties[34][key]" class="form-control" value="34">
	      <div class="col-md-4"> <label>BANDERAS DEL CÓDIGO INTERNACIONAL DE SEÑALES</label></div>
	    ...
	    <input hidden="hidden" type="text" name="properties[42][key]" class="form-control" value="42">
	      <div class="col-md-4"> <label>PABELLÓN NACIONAL </label></div>
    ...
    <hr>
  	<div class="container col-md-12">
	    ...
	    <input hidden="hidden" type="text" name="properties[54][key]" class="form-control" value="54">
	      <div class="col-md-4"> <label>EXTINTORES (DOS DE 12 KG, 2 DE 6 KG)-APROBADA NORMA NFPA 154</label></div>
	    ...
	    <input hidden="hidden" type="text" name="properties[62][key]" class="form-control" value="62">
	      ...
	      <div class="col-md-1">
	        <input type="radio" name="properties[62][value]" value="{{ old('properties[0][value]', 'NO') }}" >
	      </div>
    ...
    <hr>
  	<div class="container col-md-12">
	    ...
	    <input hidden="hidden" type="text" name="properties[93][key]" class="form-control" value="93">
	      <div class="col-md-4"> <label>BASUREROS CON RÓTULOS X BASURA (RECICLADO DE BASURA)</label></div>
    ...
    <hr>
  	<div class="container col-md-12">
	    ...
	    <input hidden="hidden" type="text" name="properties[94][key]" class="form-control" value="94">
	      ...
	      <div class="col-md-1">
	        <input type="radio" name="properties[94][value]" value="{{ old('properties[94][value]', 'NO') }}" >
	      </div>
	    ...
	    <input hidden="hidden" type="text" name="properties[95][key]" class="form-control" value="95">
	      ...
	      <div class="col-md-1">
	        <input type="radio" name="properties[95][value]" value="{{ old('properties[95][value]', 'NO') }}" >
	      </div>
	    ...
	    <input hidden="hidden" type="text" name="properties[96][key]" class="form-control" value="96">
	      ...
	      <div class="col-md-1">
	        <input type="radio" name="properties[96][value]" value="{{ old('properties[96][value]', 'NO') }}" >
	      </div>
	    ...
	    <input hidden="hidden" type="text" name="properties[97][key]" class="form-control" value="97">
	      ...
	      <div class="col-md-1">
	        <input type="radio" name="properties[97][value]" value="{{ old('properties[97][value]', 'NO') }}" >
	      </div>
	    ...
	    <input hidden="hidden" type="text" name="properties[98][key]" class="form-control" value="98">
	      ...
	      <div class="col-md-1">
	        <input type="radio" name="properties[98][value]" value="{{ old('properties[98][value]', 'NO') }}" >
	      </div>
	    ...
	    <input hidden="hidden" type="text" name="properties[99][key]" class="form-control" value="99">
	      ...
	      <div class="col-md-1">
	        <input type="radio" name="properties[99][value]" value="{{ old('properties[99][value]', 'NO') }}" >
	      </div>
	    ...
	    <input hidden="hidden" type="text" name="properties[100][key]" class="form-control" value="100">
	      ...
	      <div class="col-md-1">
	        <input type="radio" name="properties[100][value]" value="{{ old('properties[100][value]', 'NO') }}" >
	      </div>
	    ...
	    <input hidden="hidden" type="text" name="properties[101][key]" class="form-control" value="101">
	      ...
	      <div class="col-md-1">
	        <input type="radio" name="properties[101][value]" value="{{ old('properties[101][value]', 'NO') }}" >
	      </div>
    ...
    <hr>
  	<div class="container col-md-12">
	    ...
	    <input hidden="hidden" type="text" name="properties[102][key]" class="form-control" value="102">
	      ...
	      <div class="col-md-1">
	        <input type="radio" name="properties[102][value]" value="{{ old('properties[102][value]', 'NO') }}" >
	      </div>
	    ...
	    <input hidden="hidden" type="text" name="properties[103][key]" class="form-control" value="103">
	      ...
	      <div class="col-md-1">
	        <input type="radio" name="properties[103][value]" value="{{ old('properties[103][value]', 'NO') }}" >
	      </div>
	    ...
	    <input hidden="hidden" type="text" name="properties[104][key]" class="form-control" value="104">
	      ...
	      <div class="col-md-1">
	        <input type="radio" name="properties[104][value]" value="{{ old('properties[104][value]', 'NO') }}" >
	      </div>
