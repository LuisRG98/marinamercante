    ...
    <hr>
  	<div class="container col-md-12">
	    ...
	    <input hidden="hidden" type="text" name="d[6][key]" class="form-control" value="6">
	      <div class="col-md-4"> <label>LOS TRIPULANTES TIENEN CARNET DE TRIPULANTE. (EO)</label></div>
    ...
    <hr>
  	<div class="container col-md-12">
	    ...
	    <input hidden="hidden" type="text" name="d[10][key]" class="form-control" value="10">
	      <div class="col-md-4"> <label>LINTERNA DE MANO (ESTANCA). (ER)</label></div>
	    ...
	    <input hidden="hidden" type="text" name="d[11][key]" class="form-control" value="11">
	      <div class="col-md-4"> <label>SIRENA. (ER)</label></div>
	    ...
	    <input hidden="hidden" type="text" name="d[12][key]" class="form-control" value="12">
	      <div class="col-md-4"> <label>REFLECTOR DE LUZ. (ER)</label></div>
	    ...
	    <input hidden="hidden" type="text" name="m[13][key]" class="form-control" value="13">
	      <div class="col-md-4"> <label>TIENE PABELLÓN NACIONAL (VERIFICAR LAS CONDICIONES). (ER)</label></div>
	    ...
	    <input hidden="hidden" type="text" name="m[14][key]" class="form-control" value="14">
	      <div class="col-md-4"> <label>PINTADO NOMBRE/MATRÍCULA. (ER)</label></div>
	    ...
	    <input hidden="hidden" type="text" name="m[15][key]" class="form-control" value="15">
	      <div class="col-md-4"> <label>LUCES DE NAVEGACIÓN (BANDAS, TOPE, POPA). (ER)</label></div>
    ...
    <hr>
  	<div class="container col-md-12">
	    ...
	    <input hidden="hidden" type="text" name="d[19][key]" class="form-control" value="19">
	      <div class="col-md-4"> <label>BOMBA ACHIQUE. (EO)</label></div>
    ...
    <hr>
  	<div class="container col-md-12">
	    ...
	    <input hidden="hidden" type="text" name="d[27][key]" class="form-control" value="27">
	      <div class="col-md-4"> <label>MAQUINAS AUXILIARES EN BUEN ESTADO. (EO)</label></div>
    ...
    <hr>
  	<div class="container col-md-12">
	    ...
	    <input hidden="hidden" type="text" name="d[39][key]" class="form-control" value="39">
	      <div class="col-md-4"> <label>BASUREROS CON ROTULOS X BASURA (RECICLADO DE BASURA). (EO)</label></div>
    ...
    <hr>
  	<div class="container col-md-12">
	    ...
	    <input hidden="hidden" type="text" name="d[40][key]" class="form-control" value="40">
	      <div class="col-md-4"> <label>INDUMENTARIA ADECUADA DE LA TRIPULACION (OBEROL, BOTAS DE SEGURIDAD, GUANTES, GAFAS, CASCO, BARBIJO, SUPRESOR DE RUIDO). (EO)</label></div>
